...
const InfoModal: React.FC<InfoModalProps> = ({ visible, onClose }) => {
  ...
  return (
    <div className=" z-50 transition duration-300 bg-black bg-opacity-80 flex justify-center items-center overflow-hidden fixed inset-0">
        ...
        <div className={`${isVisible ? "scale-100" : "scale-0"} transform duration-300 relative flex-auto bg-zinc-900 drop-shadow-md`}>
          <div className="relative h-96">
            ...
            <div
              ...
              onClick={handleClose}
            >
              <AiOutlineClose className="text-white" size={24}></AiOutlineClose>
            </div>
